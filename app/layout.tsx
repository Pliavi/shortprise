    ...
    <html lang="pt-BR">
      <body className={inter.className}>
        <div className="flex flex-col w-dvw h-dvh relative bg-gray-900 items-center justify-center overflow-hidden text-white">
          ...
          <div className="fixed inset-0 z-20 bg-[url('/background.jpg')] bg-cover bg-center mix-blend-color-dodge opacity-25"></div>
          <div className="fixed inset-0 h-dvh sm:inset-auto sm:relative z-30 container md:max-w-[1024px] mx-auto sm:max-h-[75%] sm:h-fit flex flex-col items-center justify-stretch sm:justify-center sm:gap-6">
            ...
            <div className="w-full flex-1 overflow-y-scroll sm:h-fit bg-gray-950 bg-opacity-75 sm:rounded-2xl shadow-2xl">
              {children}
            </div>
          </div>
        </div>
